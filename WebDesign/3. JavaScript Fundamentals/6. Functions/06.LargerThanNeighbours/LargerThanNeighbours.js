...
function isElementBigger(array, position) {
    ...
    if (position < 1 || position > array.length - 2) {
        ...
        return console.log('The element at position ' + position + ' does not have 2 neighbours!!!');
            ...
            return console.log('The element at position ' + position + ' -> (' + array[position] + ') IS larger than its neighbours');
        }
         else {
            return console.log('The element at position ' + position + ' -> (' + array[position] + ') is NOT larger than its neighbours');
        }
    }
